...
function App() {
  ...
  return (
    <div 
      className="font-sans min-h-screen p-4 relative"
      style={{
        backgroundImage: 'url("/images/stadium_background.png")',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundAttachment: 'fixed'
      }}
    >
      <div className="absolute inset-0 bg-gradient-to-b from-gray-900/90 to-gray-800/90 z-0"></div>
        ...
        {!gameStarted ? (
          ...
          <>
            ...
            >
              ...
              {/* Celebration effects - Tăng cường hiệu ứng */}
              {showCelebration && (
                <div className="absolute inset-0 pointer-events-none z-[10]">
                  {/* Confetti - Tăng số lượng và kích thước */}
                  {[...Array(60)].map((_, i) => (
                    <div
                      key={i}
                      ...
                      style={{
                        left: `${Math.random() * 100}%`,
                        top: `${Math.random() * 40}%`, // Giới hạn phần trên màn hình
                ...
                <div className="grid grid-cols-2 gap-4">
                  {currentQuestion?.options.map((option, index) => (
                    <button
                      ...
                      disabled={showResult}
                      className={`p-5 rounded-lg text-base transition-all transform hover:scale-105 shadow-lg ${showResult && index === currentQuestion.correctAnswer ? 'bg-gradient-to-r from-green-600 to-green-400 text-white' :
                      ...
                      } border-b-4 ${showResult && index === currentQuestion.correctAnswer ? 'border-green-800' :
            ...
            {/* Firework particles - Tăng số lượng và kích thước */}
